...
Other approaches start with a FPGA-based architecture with a reconfigurable core \cite{dpr}, added programming schemes and new cell structures as seen in \cite{virtex4} and \cite{erlangen} or even bio-inspired hardware using the POE-model \cite{poe} as discussed in Section \ref{sec:related}.
